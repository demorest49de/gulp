...
const bcSvg = '<div class="bc__arrow-block">' + '<svg class="bc__nav-arrow">\n' + '<use href="./svg/article/nav-arrow.svg#nav-arrow"></use>\n' + '</svg>\n' + '</div>';
const breadCrumbs = {
  blogInfo: [{
    link: `<a class="bc__link" href="${bc.url}" aria-label="${bc.main}">${bc.main}</a>`,
    svg: bcSvg
  }, {
    link: `<a class="bc__link" href="${bc.blogURL}" aria-label="${bc.blog}">${bc.blog}</a>`,
    svg: ''
  }],
  articleInfo: [{
    link: `<a class="bc__link" href="${bc.url}" aria-label="${bc.main}">${bc.main}</a>`,
    ...
    link: `<a class="bc__link" href="${bc.articleURL}" aria-label="${bc.article}">${bc.article}</a>`,
    svg: ''
  }],
  categoryInfo: [{
    link: `<a class="bc__link" href="${bc.url}" aria-label="${bc.main}">${bc.main}</a>`,
    ...
    link: `<a class="bc__link" href="${bc.categoryURL}" aria-label="${bc.category}">${bc.category}</a>`,
    svg: ''
  }],
  searchInfo: [{
    link: `<a class="bc__link" href="${bc.url}" aria-label="${bc.main}">${bc.main}</a>`,
    ...
    link: `<a class="bc__link" href="${bc.searchURL}" aria-label="${bc.search}">${bc.search}</a>`,
    svg: ''
  }],
  cardInfo: {
    home: {
  ...
  cartInfo: [{
    ...
    link: `<a class="bc__link" href="${bc.cartURL}" aria-label="${bc.cart}">${bc.cart}</a>`,
    svg: ''
  }]
};
const burgerMenu = {
...
const renderSearch = $ => {
  $.searchPage.forEach(({
    ...
    if (type === $.types.main) {
      ...
      const breadCrumbs = (0,_base_breadcrumbs_js__WEBPACK_IMPORTED_MODULE_1__/* .createBreadCrumbs */ .B)($.breadCrumbs.searchInfo);
...
/* harmony import */ var _localStorage_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(863);
/* harmony import */ var _card_createCard_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(167);
/* harmony import */ var _base_breadcrumbs_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(659);
...
const renderBasket = $ => {
  $.cart.forEach(({
    ...
    if (type === $.types.main) {
      const bc = (0,_base_breadcrumbs_js__WEBPACK_IMPORTED_MODULE_5__/* .createBreadCrumbs */ .B)($.breadCrumbs.cartInfo);
...
const setBasketQuantity = () => {
  ...
  const basketArray = (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_6__/* .getStorage */ .c)(_constants_js__WEBPACK_IMPORTED_MODULE_2__/* .basketUserId */ .G9);
  if (basketArray.length > 0) {
...
const calculate = (value, id, target) => {
  ...
  (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_6__/* .setStorage */ .p)(_constants_js__WEBPACK_IMPORTED_MODULE_2__/* .basketUserId */ .G9, basketArray);
  setBasketQuantity();
  calculateTotal();
...
const calculateTotal = () => {
  const basket = (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_6__/* .getStorage */ .c)(_constants_js__WEBPACK_IMPORTED_MODULE_2__/* .basketUserId */ .G9);
      ...
      if (target.closest('.basket__trashcan-svg')) {
        ...
        liEls.forEach(el => {
          ...
          if (checkbox && checkbox.checked) {
            el.remove();
            const id = el.getAttribute('data-id');
            const storage = (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_6__/* .getStorage */ .c)(_constants_js__WEBPACK_IMPORTED_MODULE_2__/* .basketUserId */ .G9);
            const result = storage.filter(data => data.item.id !== id);
            (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_6__/* .setStorage */ .p)(_constants_js__WEBPACK_IMPORTED_MODULE_2__/* .basketUserId */ .G9, result);
            setBasketQuantity();
            removePictures(id);
            calculateTotal();
          }
...
const renderCategory = $ => {
  $.categoryPage.forEach(({
    ...
    if (type === $.types.main) {
      (0,_base_baseElems_js__WEBPACK_IMPORTED_MODULE_0__/* .createMain */ .CY)(name, $);
      const breadCrumbs = (0,_base_breadcrumbs_js__WEBPACK_IMPORTED_MODULE_1__/* .createBreadCrumbs */ .B)($.breadCrumbs.categoryInfo);
      const link = breadCrumbs.querySelector('.bc__item:nth-last-child(1) .bc__link');
      const paramsObject = (0,_base_tools_js__WEBPACK_IMPORTED_MODULE_2__/* .getSearchParams */ .Q)();
