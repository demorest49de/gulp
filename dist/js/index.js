...
;// CONCATENATED MODULE: ./src/js/module/blog/handleLoadBlog.js
const pageSettings = () => {
  return {
    currentPage: "",
    endPage: "",
...
;// CONCATENATED MODULE: ./src/js/module/article/handleLoadArticle.js
const handleLoadArticle_loadItemsHandler = $ => {
...
;// CONCATENATED MODULE: ./src/js/module/article/createArticle.js
...
const createArticle = $ => {
  ...
  handleLoadArticle_loadItemsHandler(vars);
};
;// CONCATENATED MODULE: ./src/js/module/blog/createBlog.js
...
;// CONCATENATED MODULE: ./src/js/module/shop/burger/createBurger.js
const createBurger = () => {
...
;// CONCATENATED MODULE: ./src/js/module/base/baseElems.js
...
;// CONCATENATED MODULE: ./src/js/module/blog/renderBlog.js
...
;// CONCATENATED MODULE: ./src/js/module/shop/timer.js
const handleTimer = () => {
...
;// CONCATENATED MODULE: ./src/js/module/shop/handlers.js

const handlers = $ => {
  handleTimer();
};
;// CONCATENATED MODULE: ./src/js/module/article/renderArticle.js
...
;// CONCATENATED MODULE: ./src/js/module/shop/createShop.js
...
;// CONCATENATED MODULE: ./src/js/module/constants.js
const types = {
  footer: 'footer',
  section: 'section',
  header: 'header',
...
;// CONCATENATED MODULE: ./src/js/module/base/customPaddings.js
...
;// CONCATENATED MODULE: ./src/js/module/base/baseRafAnimation.js
...
;// CONCATENATED MODULE: ./src/js/module/shop/burger/burgerHandler.js
