...
/* harmony import */ var _js_module_shop_burger_burgerHandler_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(304);
...

{
  ...
  const handlersInit = $ => {
    ...
    (0,_js_module_shop_burger_burgerHandler_js__WEBPACK_IMPORTED_MODULE_3__/* .burgerHandler */ .Y)($);
  };
  const init = (selector, page) => {
    constsInit(selector, page, _js_module_constants_js__WEBPACK_IMPORTED_MODULE_1__/* .global */ .C);
    (0,_js_module_shop_createShop_js__WEBPACK_IMPORTED_MODULE_0__/* .renderElement */ .lw)(_js_module_constants_js__WEBPACK_IMPORTED_MODULE_1__/* .global */ .C);
    handlersInit(_js_module_constants_js__WEBPACK_IMPORTED_MODULE_1__/* .global */ .C);
  };
  window.init = init;
}
...
const setCustomPaddings = $ => {
  if ($.page === _constants_js__WEBPACK_IMPORTED_MODULE_0__/* .types */ .V.blog || $.page === _constants_js__WEBPACK_IMPORTED_MODULE_0__/* .types */ .V.article) {
    console.log(' : ', $.page);
    setHeader($);
  }
};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   C: function() { return /* binding */ global; },
/* harmony export */   V: function() { return /* binding */ types; }
/* harmony export */ });
const get = 'GET';
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   X: function() { return /* binding */ createSectionCard; },
/* harmony export */   i: function() { return /* binding */ createBCCard; }
/* harmony export */ });
/* harmony import */ var _fetch_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(224);
...
const createSectionCard = (name, $, paramsObject) => {
  ...
  (0,_fetch_js__WEBPACK_IMPORTED_MODULE_0__/* .getItemById */ .PF)($, cardId).then(data => {
...
const createBCCard = ($, bc) => {
  ...
  const card = bc.card;
  const paramsURL = (0,_base_tools_js__WEBPACK_IMPORTED_MODULE_1__/* .getSearchParams */ .Q)();
  (0,_fetch_js__WEBPACK_IMPORTED_MODULE_0__/* .getItemById */ .PF)($, paramsURL.id).then(data => {
    const item = data.data;
    ul.insertAdjacentHTML('beforeend', `
            <li class="bc__item">
...
/* harmony import */ var _createCard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(167);
...
const renderCard = $ => {
  ...
  $.card.forEach(({
    ...
    if (type === $.types.main) {
      const bc = (0,_createCard_js__WEBPACK_IMPORTED_MODULE_2__/* .createBCCard */ .i)($, $.breadCrumbs.cardInfo);
      (0,_base_baseElems_js__WEBPACK_IMPORTED_MODULE_1__/* .createMain */ .CY)(name, $);
      $.main.append(bc);
      return;
    }
    if (type === $.types.section) {
      (0,_createCard_js__WEBPACK_IMPORTED_MODULE_2__/* .createSectionCard */ .X)(name, $, paramsObject);
      return;
    }
...
const createSectionRecommended = (name, $, paramsObject) => {
  ...
  (0,_fetch_js__WEBPACK_IMPORTED_MODULE_3__/* .getItemById */ .PF)($, itemId).then(data => {
    const item = data.data;
    (0,_fetch_js__WEBPACK_IMPORTED_MODULE_3__/* .getGoodsByCategory */ .n_)($, item.category).then(data => {
...
const renderCardsByCategory = ($, source, itemId) => {
  ...
  items.forEach((item, index) => {
    ...
    if (item.discount > 0) {
      cardPriceBlock.insertAdjacentHTML('beforeend', `<span class="card-category__old-price">${oldPrice} ₽</span>`);
    }
    li.append(a);
    // console.log(a);
    cards.append(li);
...
/* harmony export */ });
/* unused harmony exports createSection, renderCards */
...
/* harmony import */ var _handlers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(140);
/* harmony import */ var _article_renderArticle_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(641);
/* harmony import */ var _fetch_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(224);
/* harmony import */ var _category_renderCategory_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(989);
/* harmony import */ var _card_renderCard_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(480);
...
const createSection = (name, $, categoryName) => {
  ...
  if (name === 'wholesale') {
    $.main.insertAdjacentHTML('beforeend', `
            ...
            `);
    renderCards($, _fetch_js__WEBPACK_IMPORTED_MODULE_1__/* .getGoodsWithDiscount */ .PI).then(() => {});
    return;
  }
};
const renderShop = $ => {
...
const renderElement = $ => {
  if ($.page === 'shop') {
    renderShop($);
    (0,_handlers_js__WEBPACK_IMPORTED_MODULE_3__/* .handlers */ .q)($);
  }
  if ($.page === 'blog') {
    (0,_blog_renderBlog_js__WEBPACK_IMPORTED_MODULE_0__/* .renderBlog */ .S)($);
  }
  if ($.page === 'article') {
    (0,_article_renderArticle_js__WEBPACK_IMPORTED_MODULE_4__/* .renderArticle */ .v)($);
  }
  if ($.page === 'category') {
    (0,_category_renderCategory_js__WEBPACK_IMPORTED_MODULE_5__/* .renderCategory */ .o)($);
  }
  if ($.page === 'card') {
    (0,_card_renderCard_js__WEBPACK_IMPORTED_MODULE_6__/* .renderCard */ .Y)($);
  }
  if ($.page === 'cart') {}
};
const renderCards = async ($, callback) => {
  ...
  itemsPromise.then(source => {
    ...
    items.forEach((item, index) => {
      // console.log(' : ', item);
      cardAfterStyle.innerHTML += `.card:nth-child(${index + 1}) .card__figure:after {
                content: '-${item.discount}%';
